...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      slides={[
        ...
        {
          imageSrc: "http://img.b2bpic.net/free-photo/abstract-seamless-pattern-design_23-2151179209.jpg",
          imageAlt: "Studio",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/wallpaper-blue-orange-cubes-dark-background_1123-370.jpg",
          imageAlt: "Tech",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/professional-video-camera-stand-with-monitors-table-studio-virtual-production_1268-17880.jpg",
          imageAlt: "Equipment",
        },
        {
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        ...
        },
        {
          ...
          description: "High value long-term partnerships.",
          icon: Star,
        },
      ]}
      title="Impact at Scale"
      description="Numbers that define our creative impact."
    />
  </div>
      ...
      testimonials={[
        {
          ...
          name: "Alex Rivers",
          handle: "@arivers",
          testimonial: "Forva transformed our digital presence with unmatched quality.",
        ...
        },
        {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/business-finance-employment-female-successful-entrepreneurs-concept-smiling-professional-female-office-manager-ceo-e-commerce-company-looking-pleased-camera-white-background_1258-59171.jpg",
        },
        {
          id: "3",
          name: "Marcus Thorne",
          handle: "@mthorne",
          testimonial: "The best creative team we've worked with.",
        ...
        },
        {
          ...
          handle: "@erod",
          testimonial: "Strategic thinkers with a great aesthetic.",
        ...
        },
        {
          ...
          name: "Kevin J. Miller",
          handle: "@kjm",
          testimonial: "They built a foundation for our scale.",
      ...
      faqs={[
        {
          ...
          content: "Projects typically last between 8-12 weeks.",
        },
        {
          id: "q2",
          title: "Do you work remotely?",
          content: "Yes, we are a global, remote-first studio.",
        },
        {
          id: "q3",
  ...
  <div id="contact" data-section="contact">
      ...
      buttons={[
        {
          text: "Contact Us",
          href: "mailto:hello@forva.studios",
        },
      ]}
    />
  </div>
